...
```bash
git clone https://github.com/ksvkantipudi/AI_SOC.git
cd AI_SOC
./deploy-ai-soc.sh
```
...
Krishna Sai Vardhan Kantipudi

Data Engineer | AI/ML

Contact: kantipudivardhan789@gmail.com

## About the Developer

Krishna Sai Vardhan Kantipudi is a Data Engineer with over 3 years of experience in designing and optimizing scalable ETL/ELT pipelines, real-time data processing, and AI-powered analytics solutions. With a background in building cloud-native data platforms for enterprise networking and banking, he focuses on integrating machine learning and network telemetry into reliable, high-performance security operations workflows. This project serves as a research platform for advancing automated threat detection and response through distributed data engineering and local AI inference.