...
This directory contains documentation and scripts for acquiring and processing cybersecurity datasets used in the AI-SOC project. This repository is currently maintained and updated to support scalable data engineering workflows for security analytics.
...
Krishna is a Data Engineer with over 3 years of experience in designing and optimizing scalable ETL/ELT pipelines and AI-powered analytics solutions. He specializes in building cloud-native data platforms that support machine learning and network telemetry analytics. His work on this project focuses on streamlining the data ingestion and preprocessing workflows for cybersecurity research.

**Contact:**
- Email: kantipudivardhan789@gmail.com
- Professional Profile: LinkedIn.com/in/krishnasaivardhankantipudi
