...
Maintained by: Krishna Sai Vardhan Kantipudi
...
If you use this dataset in your research, please cite the original work and the improved study:
...
**Dataset maintained by Krishna Sai Vardhan Kantipudi**
**California State University, San Bernardino**

## About the Developer

Krishna Sai Vardhan Kantipudi is a Data Engineer (AI/ML) with over 3 years of experience in designing and optimizing scalable ETL/ELT pipelines and AI-powered analytics solutions. He specializes in building cloud-native data platforms that support machine learning and network telemetry analytics. This repository is part of his ongoing work in developing high-performance enterprise data solutions for network security and intrusion detection.
