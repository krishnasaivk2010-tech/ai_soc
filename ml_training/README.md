...
Krishna Sai Vardhan Kantipudi is a Data Engineer (AI/ML) with over 3 years of experience in designing and optimizing scalable ETL/ELT pipelines and AI-powered analytics solutions. With a background in enterprise networking and banking domains, Krishna specializes in building cloud-native data platforms using Python, Apache Spark, and MLOps workflows to support high-performance machine learning and network telemetry analytics.